 ...
 *
 * @(#) $Id: blog_post_view.php,v 1.5 2009/04/07 09:30:17 mlemos Exp $
 *
 */
...
";
	...
	{
		$output = '<div align="center"><div class="article"><h2 class="articletitle">'.HtmlSpecialChars($entry['title']).'</h2><div class="articlebody">'.nl2br(HtmlSpecialChars($entry['body'])).'</div></div></div>';
		return(1);
	}
